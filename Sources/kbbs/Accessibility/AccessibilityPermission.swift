...
public enum AccessibilityPermission {
    ...
    public static func printInstructions() {
        ...
        kbbs requested permission automatically, but macOS still requires manual approval.

        To use kbbs, you need to grant Accessibility permissions:

        1. Open System Settings > Privacy & Security > Accessibility
        2. Click the '+' button
        3. Navigate to and select the kbbs binary
        4. Enable the toggle for kbbs
        """)
    }
